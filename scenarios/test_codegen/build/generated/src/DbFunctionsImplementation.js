...
module.exports.batchSetRawEvents = (sql, entityDataArray) => {
  ...
  ${sql(valueCopyToFixBigIntType, "chain_id", "event_id", "block_number", "log_index", "transaction_index", "transaction_hash", "src_address", "block_hash", "block_timestamp", "event_type", "params")}
...
module.exports.batchSetUser = (sql, entityDataArray) => {
  ...
  ${sql(combinedEntityAndEventData, "id", "address", "gravatar", "tokens", "event_chain_id", "event_id")}
