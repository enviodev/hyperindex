...
const batchSetRawEventsCore = (sql, entityDataArray) => {
  ...
  ${sql(entityDataArray, "chain_id", "event_id", "block_number", "log_index", "transaction_index", "transaction_hash", "src_address", "block_hash", "block_timestamp", "event_type", "params")}
...
const batchSetDynamicContractRegistryCore = (sql, entityDataArray) => {
  ...
  ${sql(entityDataArray, "chain_id", "event_id", "contract_address", "contract_type")}
...
${sql(combinedEntityAndEventData, "id", "address", "gravatar", "updatesCountOnUserForTesting", "tokens", "event_chain_id", "event_id")}
...
${sql(combinedEntityAndEventData, "id", "owner", "displayName", "imageUrl", "updatesCount", "event_chain_id", "event_id")}
  ON CONFLICT(id) DO UPDATE
  SET
  "id" = EXCLUDED."id",
...
${sql(combinedEntityAndEventData, "id", "contractAddress", "name", "symbol", "maxSupply", "currentSupply", "event_chain_id", "event_id")}
  ON CONFLICT(id) DO UPDATE
  SET
  "id" = EXCLUDED."id",
...
${sql(combinedEntityAndEventData, "id", "tokenId", "collection", "owner", "event_chain_id", "event_id")}
  ON CONFLICT(id) DO UPDATE
  SET
  "id" = EXCLUDED."id",
...
${sql(combinedEntityAndEventData, "id", "b", "event_chain_id", "event_id")}
  ON CONFLICT(id) DO UPDATE
  SET
  "id" = EXCLUDED."id",
  "b" = EXCLUDED."b",
...
${sql(combinedEntityAndEventData, "id", "a", "c", "event_chain_id", "event_id")}
  ON CONFLICT(id) DO UPDATE
  SET
  "id" = EXCLUDED."id",
  "a" = EXCLUDED."a",
...
${sql(combinedEntityAndEventData, "id", "a", "event_chain_id", "event_id")}
  ON CONFLICT(id) DO UPDATE
  SET
  "id" = EXCLUDED."id",
  "a" = EXCLUDED."a",
