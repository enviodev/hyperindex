...
export const GravatarContract_registerTestEventHandler: (
  handler: (_1: {
    readonly event: Types_eventLog<Types_GravatarContract_TestEventEvent_eventArgs>;
    readonly context: Types_GravatarContract_TestEventEvent_context;
  }) => void
) => void = function(Arg1: any) {
  const result = HandlersBS.GravatarContract.registerTestEventHandler(function(
    Argevent: any,
    Argcontext: any
  ) {
...
export const GravatarContract_registerNewGravatarHandler: (
  handler: (_1: {
    readonly event: Types_eventLog<Types_GravatarContract_NewGravatarEvent_eventArgs>;
    readonly context: Types_GravatarContract_NewGravatarEvent_context;
  }) => void
) => void = function(Arg1: any) {
  const result = HandlersBS.GravatarContract.registerNewGravatarHandler(
    function(Argevent: any, Argcontext: any) {
      const result1 = Arg1({ event: Argevent, context: Argcontext });
      return result1;
    }
  );
...
export const GravatarContract_registerUpdatedGravatarHandler: (
  handler: (_1: {
    readonly event: Types_eventLog<Types_GravatarContract_UpdatedGravatarEvent_eventArgs>;
    readonly context: Types_GravatarContract_UpdatedGravatarEvent_context;
  }) => void
) => void = function(Arg1: any) {
  const result = HandlersBS.GravatarContract.registerUpdatedGravatarHandler(
    function(Argevent: any, Argcontext: any) {
      const result1 = Arg1({ event: Argevent, context: Argcontext });
      return result1;
    }
