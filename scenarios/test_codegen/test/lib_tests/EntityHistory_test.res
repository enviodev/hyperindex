...
// type testEntityHistory = EntityHistory.entityUpdate<TestEntity.t>
// let testEntitySetUpdateSchema = EntityHistory.makeSetUpdateSchema(TestEntity.schema)
...
//     let storage = PgStorage.make(~logger=Logger.quiet(),
//       ~sql=Db.sql,
