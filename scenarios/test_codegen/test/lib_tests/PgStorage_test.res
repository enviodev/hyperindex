...
CREATE TABLE IF NOT EXISTS "test_schema"."envio_info"("id" INTEGER NOT NULL, "config" JSONB NOT NULL, PRIMARY KEY("id"));
...
CREATE TABLE IF NOT EXISTS "public"."envio_info"("id" INTEGER NOT NULL, "config" JSONB NOT NULL, PRIMARY KEY("id"));
