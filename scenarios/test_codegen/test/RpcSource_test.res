...
describe("RpcSource - getEventTransactionOrThrow", () => {
  ...
  Async.it(
    ...
    async t => {
      ...
      t.expect(
        await mockLog()->getEventTransactionOrThrow(~transactionFieldNames=[]),
      ).toEqual(
        %raw(`{}`),
      )
    },
  ...
  Async.it("Works with a single transactionIndex field", async t => {
    ...
    t.expect(
      await mockLog()->getEventTransactionOrThrow(
        ~transactionFieldNames=["transactionIndex"],
      ),
    ).toEqual(
      {
        "transactionIndex": 1,
  ...
  Async.it("Works with a only transactionIndex & hash field", async t => {
    ...
    t.expect(
      await mockLog()->getEventTransactionOrThrow(
        ~transactionFieldNames=["hash", "transactionIndex"],
      ),
    ).toEqual(
      {
        "hash": "0xabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdef",
    ...
    t.expect(
      await mockLog()->getEventTransactionOrThrow(
        ~transactionFieldNames=["transactionIndex", "hash"],
      ),
    ).toEqual(
      {
        "hash": "0xabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdef",
  ...
  Async.it(
    ...
    async t => {
      ...
      t.expect(
        await mockLog()->getEventTransactionOrThrow(
          ~transactionFieldNames=["from", "gas"],
        ),
      ).toEqual(
        {
          "from": "0x95222290DD7278Aa3Ddd389Cc1E1d165CC4BAfe5"->Address.Evm.fromStringOrThrow,
  ...
  Async.it(
    ...
    async t => {
      ...
      t.expect(
        await mockLog()->getEventTransactionOrThrow(
          ~transactionFieldNames=["cumulativeGasUsed"],
        ),
      ).toEqual(
  ...
  Async.it(
    ...
    async t => {
      ...
      t.expect(
        await mockLog()->getEventTransactionOrThrow(
          ~transactionFieldNames=["hash", "gas", "gasUsed", "effectiveGasPrice", "status"],
        ),
      ).toEqual(
        {
          "hash": "0xabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdef",
  ...
  Async.it(
    ...
    async t => {
      ...
      t.expect(
        await mockLog()->getEventTransactionOrThrow(
          ~transactionFieldNames=["gas", "input"],
        ),
      ).toEqual(
        {
          "gas": 21000n,
  ...
  Async.it(
    ...
    async t => {
      ...
      t.expect(
        await mockLog()->getEventTransactionOrThrow(
          ~transactionFieldNames=["l1FeeScalar"],
        ),
      ).toEqual(
        {"l1FeeScalar": 0.684},
      )
  ...
  Async.it("Address fields are normalized with lowercaseAddresses=true", async t => {
    ...
    let result = await mockLog()->getEventTransactionOrThrow(
      ~transactionFieldNames=["from", "contractAddress"],
    )
    t.expect(
      result,
    ).toEqual(
...
describe("RpcSource - getEventBlockOrThrow", () => {
  ...
  Async.it(
    ...
    async t => {
      ...
      t.expect(
        (await mockLog()->getEventBlockOrThrow(~blockFieldNames=[]))->toJson,
      ).toEqual(
        %raw(`{}`),
      )
    },
  ...
  Async.it("Works with number, timestamp, and hash fields", async t => {
    ...
    t.expect(
      (await mockLog()->getEventBlockOrThrow(
        ~blockFieldNames=["number", "timestamp", "hash"],
      ))->toJson,
    ).toEqual(
  ...
  Async.it("Parses selected block fields from raw JSON", async t => {
    ...
    t.expect(
      (await mockLog()->getEventBlockOrThrow(
        ~blockFieldNames=["gasUsed", "gasLimit"],
      ))->toJson,
    ).toEqual(
  ...
  Async.it("Parses optional fields correctly (nullable with value)", async t => {
    ...
    let result = (await mockLog()->getEventBlockOrThrow(
      ~blockFieldNames=["baseFeePerGas", "difficulty"],
    ))->toJson
