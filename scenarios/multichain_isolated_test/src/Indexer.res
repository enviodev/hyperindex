...
type contractRegisterChain = {
  id: chainId,
  \"Counter": contractRegisterContract,
}
...
let contractName = "Counter"
  ...
  type rec eventIdentity<'event, 'paramsConstructor, 'where> =
    | @as("Increment") Increment: eventIdentity<Increment.event, Increment.paramsConstructor, Increment.onEventWhere>
}
...
type eventIdentity<'event, 'paramsConstructor, 'where> =
  | Counter(Counter.eventIdentity<'event, 'paramsConstructor, 'where>)
