...
export type StatusInput = Enum<{ Pending: undefined, Completed: BigNumberish, Failed: StatusFailureInput }>;
export type StatusOutput = Enum<{ Pending: void, Completed: number, Failed: StatusFailureOutput }>;

export type AddressInput = { bits: string };
export type AddressOutput = AddressInput;
export type ContractIdInput = { bits: string };
export type ContractIdOutput = ContractIdInput;
export type SimpleStructInput = { f1: BigNumberish };
export type SimpleStructOutput = { f1: number };
export type SimpleStructWithOptionalFieldInput = { f1: BigNumberish, f2: Option<BigNumberish> };
export type SimpleStructWithOptionalFieldOutput = { f1: number, f2: Option<number> };
export type StatusFailureInput = { reason: BigNumberish };
export type StatusFailureOutput = { reason: number };
...
export class AllEventsInterface extends Interface {
  constructor() {
    super(abi);
  }
...
export class AllEvents extends Contract {
  static readonly abi = abi;
  static readonly storageSlots = storageSlots;

  declare interface: AllEventsInterface;
  declare functions: {
    deposit: InvokeFunction<[recipient: IdentityInput], void>;
    withdraw: InvokeFunction<[recipient: IdentityInput], void>;
    log: InvokeFunction<[], void>;
  };
