...
// Builds a per-event registration for the `mock` helpers below. All test
// cases here use filterByAddresses=false and startBlock/handler/contractRegister=None,
// and dependsOnAddresses always follows the shared `!isWildcard` formula since
// none of these mocked events filter by addresses.
let mkRegistration = (
  ~id,
  ~name,
  ~contractName,
      ...
      ~contracts=[
        {
          name: "TestContract",
          events: [
            mkRegistration(~id="Mint", ~name="Mint", ~contractName="TestContract", ~kind=Mint),
          ],
        },
        {
          name: "TestContract2",
          events: [
            mkRegistration(~id="Mint", ~name="Mint", ~contractName="TestContract2", ~kind=Mint),
          ],
        },
      ],
    )
      ...
      ~contracts=[
        {
          name: "TestContract",
          events: [
            mkRegistration(~id="Burn", ~name="Burn", ~contractName="TestContract", ~kind=Burn),
          ],
        },
        {
          name: "TestContract2",
          events: [
            mkRegistration(~id="Burn", ~name="Burn", ~contractName="TestContract2", ~kind=Burn),
          ],
        },
      ],
    )
          ...
          ~contracts=[
            {
              name: "TestContract",
              events: [
                mkRegistration(~id="Call", ~name="Call", ~contractName="TestContract", ~kind=Call),
              ],
            },
          ],
        )
