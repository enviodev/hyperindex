...
module ResponseTypes = {
  ...
  let blockDataSchema = S.object(s => {
    ...
    difficulty: ?s.field("difficulty", S.option(S.null(BigInt_.schema))),
    totalDifficulty: ?s.field("total_difficulty", S.option(S.null(BigInt_.schema))),
    extraData: ?s.field("extra_data", S.option(S.string)),
    size: ?s.field("size", S.option(BigInt_.schema)),
    gasLimit: ?s.field("gas_limit", S.option(BigInt_.schema)),
    gasUsed: ?s.field("gas_used", S.option(BigInt_.schema)),
    timestamp: ?s.field("timestamp", S.option(BigInt_.schema)),
    uncles: ?s.field("unclus", S.option(S.null(S.string))),
    baseFeePerGas: ?s.field("base_fee_per_gas", S.option(S.null(BigInt_.schema))),
  })
  ...
  let transactionDataSchema = S.object(s => {
    ...
    gas: ?s.field("gas", S.option(BigInt_.schema)),
    gasPrice: ?s.field("gas_price", S.option(S.null(BigInt_.schema))),
    hash: ?s.field("hash", S.option(S.string)),
    ...
    value: ?s.field("value", S.option(BigInt_.schema)),
    v: ?s.field("v", S.option(S.null(S.string))),
    r: ?s.field("r", S.option(S.null(S.string))),
    s: ?s.field("s", S.option(S.null(S.string))),
    maxPriorityFeePerGas: ?s.field("max_priority_fee_per_gas", S.option(S.null(BigInt_.schema))),
    maxFeePerGas: ?s.field("max_fee_per_gas", S.option(S.null(BigInt_.schema))),
    chainId: ?s.field("chain_id", S.option(S.null(S.int))),
    cumulativeGasUsed: ?s.field("cumulative_gas_used", S.option(BigInt_.schema)),
    effectiveGasPrice: ?s.field("effective_gas_price", S.option(BigInt_.schema)),
    gasUsed: ?s.field("gas_used", S.option(BigInt_.schema)),
