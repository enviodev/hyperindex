...
module ResponseTypes = {
  type blockData = {
    ...
    difficulty?: option<BigInt.t>,
    totalDifficulty?: option<BigInt.t>,
    extraData?: string,
    size?: BigInt.t,
    gasLimit?: BigInt.t,
    gasUsed?: BigInt.t,
  ...
  type transactionData = {
    ...
    r?: option<string>,
    s?: option<string>,
    maxPriorityFeePerGas?: option<BigInt.t>,
    maxFeePerGas?: option<BigInt.t>,
    chainId?: option<int>,
