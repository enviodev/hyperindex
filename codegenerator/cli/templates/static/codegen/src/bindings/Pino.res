...
let createPinoMessage = (message): pinoMessageBlob => X.magic(message)
...
module Transport = {
  type t
  type optionsObject
  let makeTransportOptions: 'a => optionsObject = X.magic
...
type childParams
let createChildParams: 'a => childParams = X.magic
