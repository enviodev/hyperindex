...
pub fn network_to_skar_url(network: &SupportedNetwork) -> Option<String> {
    match network {
        ...
        SupportedNetwork::BinanceChain => Some("http://bsc.hypersync.bigdevenergy.link:1103".to_string()),
        SupportedNetwork::EthereumGoerliTestnet => Some("http://goerli.hypersync.bigdevenergy.link:1104".to_string()),
        SupportedNetwork::Linea => Some("http://linea.hypersync.bigdevenergy.link:1107".to_string()),
        SupportedNetwork::EthereumSepoliaTestnet => Some("http://sepolia.hypersync.bigdevenergy.link:1108".to_string()),
        _ => None
