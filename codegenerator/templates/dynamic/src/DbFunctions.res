...
module {{entity.name.capitalized}} = {
  ...
  @module("./DbFunctionsImplementation.js")
  external read{{entity.name.capitalized}}Entities: array<Types.id> => promise<array<Types.inMemoryStoreRow<Types.{{entity.name.uncapitalized}}Entity>>> = "read{{entity.name.capitalized}}Entities"
}
{{/each}}
