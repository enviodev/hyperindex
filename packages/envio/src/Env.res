...
// Max uncommitted entity/effect changes plus unwritten batch items the
// in-memory store holds before processing waits for the write cycle to catch up.
let maxInMemoryChanges =
  envSafe->EnvSafe.get("ENVIO_MAX_IN_MEMORY_CHANGES", S.int, ~fallback=100_000)->Belt.Int.toFloat
