...
pub struct StartArgs {
    ...
    ///per two connections, so its default of 10 affords five. A schema with an entity shared
    ///across chains, or a budget under 4, runs in one process as it always has.
