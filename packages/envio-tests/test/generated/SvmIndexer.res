...
type contractRegisterChain = {
  id: chainId,
  \"Swapper": contractRegisterContract,
}
...
let contractName = "Swapper"
  ...
  type rec eventIdentity<'event, 'paramsConstructor, 'where> =
    | @as("Swap") Swap: eventIdentity<Swap.event, Swap.paramsConstructor, Swap.onEventWhere>
}
...
type eventIdentity<'event, 'paramsConstructor, 'where> =
  | Swapper(Swapper.eventIdentity<'event, 'paramsConstructor, 'where>)
